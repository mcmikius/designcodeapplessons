...
class MyViewController : UIViewController {
    ...
    override func loadView() {
        ...
        descriptionLabel.text = "These years ago, Apple completely revamped their design language for the modern users. It is now much simpler, allowing designers to focus on animation and function rether then intricate visual details."
